    ...
    <section className="relative w-full z-10 flex justify-center items-center font-primary-regular">
      ...
      <div className="bg-linear-to-r from-[#5ed7fc] to-[#0379ff] rounded-[16px] lg:rounded-[35px] w-full relative z-10">
        <img
          src={bgImage}
          alt="Your Image"
          className="w-full z-0 opacity-[0.3] h-72 md:h-96 lg:h-[35rem] rounded-[16px] lg:rounded-[35px]"
        />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white z-20 text-center hidden lg:block">
          ...
          <h3 className="heading-h3 font-primary-medium mb-7 mt-3 uppercase">
            TAKE YOUR TEAM TO THE NEXT LEVEL - <br />
            OUTSTAFF WITH US!
          </h3>

          <div className="flex group items-center justify-center">
            <button className="bg-[#FFFBF0] text-[#37508A] text-[14px] md:text-[16px] rounded-full flex p-4 px-6 md:px-8 w-[190px] md:w-[220px] items-center transition-all duration-300 ease-in-out group-hover:w-[140px] md:group-hover:w-[170px]">
              CONNECT US
            </button>
            <span className="relative w-[40px] h-[40px] md:w-[40px] md:h-[40px] right-2 bg-[#13B2F5] rounded-full flex justify-center items-center -ml-10 md:-ml-10 group-hover:ml-3 transition-all duration-300 ease-in-out">
        ...
        <div className="absolute inset-0 flex-col justify-center text-white z-20 text-center hidden md:flex lg:hidden">
          ...
          <h3 className="heading-h3 font-primary-medium uppercase w-[80%] mx-auto">
            TAKE YOUR TEAM TO THE NEXT LEVEL - <br />
            OUTSTAFF WITH US!
          </h3>
          <div className="flex group items-center justify-center">
        ...
        <div className="absolute inset-0 flex flex-col justify-center text-white z-20 text-center sm:block md:hidden lg:hidden">
          ...
          <div className="flex group items-center justify-center mt-2">
            <button className="bg-[#FFFBF0] text-[#37508A] text-[13px] md:text-[16px] rounded-full flex p-2 md:p-4 px-4 md:px-8 w-[150px] md:w-[220px] items-center transition-all duration-300 ease-in-out group-hover:w-[115px] md:group-hover:w-[170px]">
              CONNECT US
            </button>
            <span className="relative w-[28px] h-[28px] md:w-[40px] md:h-[40px] right-2 bg-[#13B2F5] rounded-full flex justify-center items-center -ml-7 md:-ml-10 group-hover:ml-3 transition-all duration-300 ease-in-out">
