...
import banner from "/solutions/lidar-annotations/banner/lidar-banner.jpg";
        ...
        <div className="absolute inset-0 flex flex-col mx-auto container justify-center items-center lg:items-start lg:left-[6%]">
          ...
          <div className="hidden lg:flex flex-col text-center lg:text-left justify-center items-center lg:justify-start lg:items-start lg:leading-8 text-[#FFFBF0] text-[16px] md:text-[20px] lg:text-[23px] mt-3 w-[90%] lg:w-[70%]">
            <p className="paragraph">
              The demand for fast, high-quality LiDAR annotation is growing
              rapidly. This annotation is the foundation for training powerful
              AI models in complex 3D environments. By accurately labeling LiDAR
              data, AI systems improve spatial awareness, enabling better
              obstacle detection and navigation. This enhances decision-making
              and boosts performance, leading to safer and more efficient
          ...
          <div className="lg:hidden flex flex-col text-center lg:text-left justify-center items-center lg:justify-start lg:items-start lg:leading-8 text-[#FFFBF0] text-[16px] md:text-[20px] lg:text-[23px] mt-3 w-[90%] lg:w-[70%]">
            ...
            >
              <p>
                The demand for fast, high-quality LiDAR annotation is growing
                rapidly. This annotation is the foundation for training powerful
                AI models in complex 3D environments. By accurately labeling
                LiDAR data, AI systems improve spatial awareness, enabling
                better obstacle detection and navigation. This enhances
                decision-making and boosts performance, leading to safer and
