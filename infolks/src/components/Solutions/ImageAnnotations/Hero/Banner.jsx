...
import banner from "/solutions/image-annotations/banner/banner.mp4";
  ...
  return (
    <section className="h-screen relative font-primary-regular">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 h-screen bg-linear-to-l from-[#ccd2f01f]  to-[#021aa1ab] bg-opacity-70"></div>
        ...
        <div className="absolute inset-0 flex flex-col mx-auto container justify-center items-center lg:items-start lg:left-[6%]">
          <h1 className="hero-banner-heading-h1 lg:leading-[63px] 2xl:leading-[70px]">
            BEST IMAGE
            <br /> ANNOTATION SERVICES FOR AI MODELS
          </h1>
          <div className="flex flex-col text-center lg:text-left justify-center items-center lg:justify-start lg:items-start lg:leading-8 text-[#FFFBF0] text-[16px] md:text-[20px] lg:text-[23px] mt-3 w-[90%] lg:w-[70%]">
            <p className="hidden lg:block paragraph">
                Image annotation services are essential for helping AI
                understand visual data. By accurately labeling objects and
                features within images using techniques like bounding boxes,
                segmentation, and keypoints, these services boost the accuracy
                of AI models in recognizing and classifying complex visuals. The
                quality of annotations directly impacts AI’s performance and
                reliability.<p className="mt-2"></p>
            </p>
          </div>
