...
import banner from "/solutions/odc/banner/banner.jpg";
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col mx-auto container justify-center items-center lg:items-start lg:left-[6%]">
          ...
          <div className="hidden lg:flex flex-col text-center lg:text-left justify-center items-center lg:justify-start lg:items-start lg:leading-8 text-[#FFFBF0] text-[16px] md:text-[20px] lg:text-[23px] mt-3 w-[90%] lg:w-[70%]">
           ...
           An Offshore Development Center (ODC) is a remote software or IT services set up in a location separate from its main headquarters, frequently in another country. It taps into global talent and resources to deliver quality, cost-effective, and innovative solutions. ODCs provide international clients with scalable, customized services, effective project management, and access to diverse expertise.
            </p>
          </div>
          ...
          <h5 className="heading-h5 text-white mt-5 text-center lg:text-left">
            &quot;We offer outsourcing services for <br /> situations where you
            lack in-house capacity or expertise.&quot;
          </h5>
        </div>
      </div>
    </section>
