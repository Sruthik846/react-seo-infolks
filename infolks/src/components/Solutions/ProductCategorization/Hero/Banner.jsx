...
import banner from "/solutions/product-categorization/banner/banner.jpg";
        ...
        <div className="absolute inset-0 flex flex-col mx-auto container justify-center items-center lg:items-start lg:left-[6%]">
          ...
          <p className="flex flex-col text-center lg:text-left justify-center items-center lg:justify-start lg:items-start lg:leading-8 text-[#FFFBF0] text-[16px] md:text-[20px] lg:text-[23px] mt-3 w-[90%] lg:w-[70%]">
            <ReadMoreLessParagraph
              id="product_categorization_banner"
              charLimit={charLimit}
            ...
            >
              <p>
                An AI-powered categorization system is designed to streamline
                retail operations by automatically sorting and organising vast
                product inventories. Leveraging advanced algorithms, our system
                efficiently categorises products based on various attributes,
                ensuring accuracy and relevance in cataloging.
              </p>
              <p className="mt-2">
                Infolks provides best-in-class product categorization services
                by systematically classifying and labeling diverse forms of
                user-generated content, including text, video, and images.
              </p>
            </ReadMoreLessParagraph>
          </p>
        </div>
