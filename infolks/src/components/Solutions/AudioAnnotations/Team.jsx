...
const Team = ({ content, content2, image1, image2 }) => {
  return (
    <section className="lg:px-20 2xl:px-56 lg:py-0 p-2 md:p-4 lg:pb-40 2xl:pb-48 lg:mt-20 relative font-primary-regular text-[#37508A]">
     
        <h2 className="heading-h2 text-[#37508A] text-center lg:pb-20 flex justify-center items-center uppercase lg:leading-[50px] 2xl:leading-[63px]">
        BEST-IN-QUALITY <br />AUDIO ANNOTATION SERVICES
        </h2>
