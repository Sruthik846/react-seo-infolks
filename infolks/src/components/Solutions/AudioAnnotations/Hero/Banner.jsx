...
import banner from "/solutions/audio-annotations/banner/banner.mp4";
    ...
    <section className="h-screen relative font-primary-regular">
      ...
      <div className="relative overflow-hidden">
        ...
        PERFECT AUDIO <br />
            ...
            <p className="paragraph hidden lg:block">Audio annotation involves labeling sounds, speech, and tones to make audio data usable for machine learning models. It’s essential for training NLP and speech recognition systems. Detailed annotation helps AI recognize speech nuances, accents, and intonations, improving the accuracy of voice assistants and other audio-based technologies. Our expert team ensures high-quality annotated audio to power your AI models. </p>
          ...
          <div className="lg:hidden flex flex-col text-center lg:text-left justify-center items-center lg:justify-start lg:items-start lg:leading-8 text-[#FFFBF0] text-[16px] md:text-[20px] lg:text-[23px] mt-3 w-[90%] lg:w-[70%]">
            ...
            >
              <p>Audio annotation involves labeling sounds, speech, and tones to make audio data usable for machine learning models. It’s essential for training NLP and speech recognition systems. Detailed annotation helps AI recognize speech nuances, accents, and intonations, improving the accuracy of voice assistants and other audio-based technologies. Our expert team ensures high-quality annotated audio to power your AI models. </p>
              <p></p>
            </ReadMoreLessParagraph>
          </div>
        </div>
