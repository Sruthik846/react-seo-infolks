...
import banner from "/security/banner.jpg";
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col mx-auto container justify-center items-center lg:items-start lg:left-[6%]">
          ...
          <p className="flex flex-col text-center lg:text-left justify-center items-center lg:justify-start lg:items-start lg:leading-8 text-[#FFFBF0] text-[16px] md:text-[20px] lg:text-[23px] mt-3 w-[90%] lg:w-[70%]">
            ...
            >
              It is our responsibility to ensure the integrity, privacy, and
              security of the data undergoing processing. At Infolks, we
              understand the paramount importance of data security in data
              labeling services and are committed to maintaining the highest
              standards in this regard. We respect data security the most and
              ensure that your information gets the same respect.
            </ReadMoreLess>
          </p>
        </div>
      </div>
