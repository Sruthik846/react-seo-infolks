...
const Report = ({ reportImage, content, reportContent, reportid }) => {
  ...
  return (
    <div className="flex w-full justify-center items-center flex-col pt-10 lg:pt-16 2xl:pt-28 -mt-16 responsive-section-container">
      ...
      AI IN THE AGRICULTURE INDUSTRY <br /> WITH ANNOTATED DATA
      </h2>

        {/* Medium screen */}
      <h2 className="block sm:hidden text-center mb-2 uppercase heading-h2 mx-auto">
      AI IN THE AGRICULTURE INDUSTRY WITH ANNOTATED DATA
      </h2>
      <div className="text-center mx-auto container">
        ...
        <div>
          ...
          {reportContent && (
            <div className="grid grid-cols-1 mt-5 h-46 sm:h-28 md:h-28 lg:h-32">
              <div className="relative group">
                <div className="bg-[#FBF7ED] lg:w-full absolute top-0 ml-2 z-0 p-2 md:p-5 rounded-[20px] border border-[#5F82CC]">
                  <p className="paragraph mx-2 sm:mx-10 xl:mx-36">{reportContent}</p>
                </div>
