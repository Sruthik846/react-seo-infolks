  ...
  const initialState = [
    {
      ...
      content: `We have specialised annotator
    teams for different areas from
    medical to automotive, ensuring
    ...
    },
    {
      ...
      content: `Our industry experience allows
    us to provide accurate
    annotations tailored to specific
    industry needs.`,
      active: true,
      img: bgimage2,
    ...
    },
    {
      ...
      content: `Each annotated output
    undergoes a rigorous triple-level quality check to ensure
    ...
    delivering annotated data within
    specified timelines, ensuring that
    our clients' projects progress
    smoothly.`,
      active: true,
      img: bgimage2,
      icon: timelyDelivery,
    ...
    },
    {
      ...
      content: `We focus on understanding our
    clients' needs to offer tailored
    annotation solutions that align
    with their goals effectively.`,
      active: false,
      img: bgimage1,
    ...
    },
    {
      ...
      content: `We try to continuously refine
    annotation techniques and
    approaches based on industry
