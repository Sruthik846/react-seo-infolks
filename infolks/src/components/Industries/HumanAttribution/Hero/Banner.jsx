...
import banner from "/industries/human attribution/banner/banner.mp4";
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col mx-auto container justify-center items-center lg:items-start lg:left-[6%]">
          <h1 className="text-white hero-banner-heading-h1 text-center lg:text-left">
            PRECISELY ANNOTATED <br />
            DATA FOR AI RECOGNITION MODELS
          </h1>
            ...
            <p className="paragraph hidden lg:block"> 
             Data annotation accurately labels human actions and features in images and videos, improving models’ ability to recognize complex behaviors. This precision is essential for developing effective, reliable human recognition technologies across various applications.
            </p>
          </div>
