...
import security_and_survilance from "/industries/security & surveilance/security_and_survilance.mp4";
  ...
  return (
    <section className="h-screen relative font-primary-regular">
      ...
      <div className="relative">
        ...
        >
          {" "}
          <source src={security_and_survilance} type="video/mp4" />
          ...
          <h1 className="text-white hero-banner-heading-h1 text-center lg:text-left">
           ...
           <div className="flex flex-col text-center lg:text-left justify-center items-center lg:justify-start lg:items-start lg:leading-8 text-[#FFFBF0] text-[16px] md:text-[20px] lg:text-[23px] mt-3 w-[90%] lg:w-[70%]">
            <p className="paragraph hidden lg:block">
             Retail and e-commerce are changing fast, with smart tech improving how businesses connect with customers, manage stock, and streamline operations. Accurate data labeling helps systems learn buying habits and trends, leading to smarter decisions and better shopping experiences.
            </p>
          </div>
