...
const Report = ({ reportImage, content, content2, reportContent, reportid }) => {
  ...
  return (
    <div className="flex w-full justify-center items-center flex-col pt-10 lg:pt-16 2xl:pt-28 -mt-16 responsive-section-container">
      {/* Large screen */}
      <h2 className="hidden sm:block text-center mb-2 lg:mb-5 2xl:mb-10 uppercase heading-h2 mx-auto lg:leading-[63px]">
      HIGH QUALITY DATASET <br /> FOR AI IN LIVESTOCK MANAGEMENT
      </h2>

        {/* Medium screen */}
      <h2 className="block sm:hidden text-center mb-2 uppercase heading-h2 mx-auto">
      HIGH QUALITY DATASET FOR AI IN LIVESTOCK MANAGEMENT
      </h2>
      ...
      <div className="lg:mx-auto lg:w-[87%] 3xl:w-full">
        ...
        <div>
          ...
          {reportContent && (
            <div className="grid grid-cols-1 mt-5 h-44 sm:h-28 lg:h-32">
              <div className="relative group">
                <div className="bg-[#FBF7ED] lg:w-full absolute top-0 ml-2 z-0 p-2 md:p-5 rounded-[20px] border border-[#5F82CC]">
                  <p className="paragraph lg:mx-10 xl:mx-10">{reportContent}</p>
                </div>
