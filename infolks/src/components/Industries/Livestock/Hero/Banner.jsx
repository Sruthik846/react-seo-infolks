...
import livestock from "/industries/livestock/livestock.mp4";
  ...
  return (
    <section className="h-screen relative font-primary-regular">
      ...
      <div className="relative">
        ...
        >
          {" "}
          <source src={livestock} type="video/mp4" />
        ...
        <div className="absolute inset-0 flex flex-col mx-auto container justify-center items-center lg:items-start lg:left-[6%]">
          <h1 className="text-white hero-banner-heading-h1 text-center lg:text-left">
            ...
            <p className="paragraph hidden lg:block">
              The livestock industry is evolving with smart technology, bringing precision and fresh insights to animal management. From improving welfare to boosting productivity, accurate data labeling is key to building systems that support better, more sustainable farming decisions.
            </p>
          </div>
