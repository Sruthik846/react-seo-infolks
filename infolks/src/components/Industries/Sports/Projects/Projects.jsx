...
import live_data_correction from "/industries/sports/live-data-correction.jpg";
import event_detection_in_sports from "/industries/sports/event-detection-in-sports.jpg";
import soccer_ball_labeling from "/industries/sports/soccer-ball-labeling.jpg";
import afl_ball_labeling from "/industries/sports/afl-ball-labeling.jpg";
import athlete_posture_labeling from "/industries/sports/athlete-posture-labeling.jpg";
import card_defect_detection from "/industries/sports/card-defect-detection.jpg";
...
const RecentAnnotations = () => {
  ...
  const data = [
    {
      id: "01",
      headinh1: "Live Data Correction",
      heading2: " ",
      content: `In the fast-paced world of sports, precision in live data is essential, particularly in high-speed games like football. Our data annotation services enhance AI in the sports industry by ensuring real-time accuracy. We collect and tag live data, delivering seamless and error-free updates to sports enthusiasts, analysts, and professionals, enhancing the overall experience for everyone involved.`,
      img: live_data_correction,
    },
    {
      id: "02",
      headinh1: "Event Detection in Sports",
      heading2: "",
      content: `Precision and real-time insights are critical in the dynamic world of sports.  Our data annotation services are at the forefront, revolutionising the industry with precise event detection. Our professional experts annotate sports data, catch every critical moment, and transform raw data into valuable insights. With our innovative solutions, the sports industry can make data-driven decisions, ensuring that each match and victory becomes a masterpiece of insightful analysis.`,
      img: event_detection_in_sports,
    },
    {
      id: "03",
      headinh1: "Soccer Ball Labeling",
      heading2: "",
      content: `We label players and a soccer ball in a given frame of a match. This data will train computer vision algorithms for player tracking and ball detection. Accuracy and consistency are key for effective AI model development.`,
      img: soccer_ball_labeling,
    },
    {
      id: "04",
      headinh1: "AFL Ball Labeling",
      heading2: "",
      content: `This project aims to label the AFL ball in a provided frame, which is vital for training computer vision systems. This labeled data will advance ball trajectory analysis and player performance evaluation. Ensuring accuracy and consistency in labeling is paramount for developing robust machine-learning models.`,
      img: afl_ball_labeling,
    },
    {
      id: "05",
      headinh1: "Athlete Posture Labeling",
      heading2: "",
      content: `Labeling athletes' skeleton/body joints across various athletic stances is the objective. This data will train computer vision systems for movement analysis and injury prevention. Ensuring accuracy and consistency in labeling is essential for effective model development.`,
      img: athlete_posture_labeling,
    },
    {
      id: "06",
      headinh1: "Card Defect Detection",
      heading2: "",
      content: `Identifying and labeling card defects is essential. This data will train models to enhance defect detection algorithms, ensuring product quality. Accuracy and consistency in labeling are crucial for effective system development.`,
      img: card_defect_detection,
    },
  ];
  ...
  return (
    <section className="flex flex-col lg:flex-row gap-2 md:gap-4 xl:gap-32 lg:mt-8 font-primary-regular mb-5 md:mb-14">
      <div className="">
        <h2 className="mt-10 lg:mt-5 heading-h2 text-center lg:text-left lg:mb-5 uppercase w-full lg:w-2/3 lg:pl-14 2xl:pl-20 lg:leading-[50px] 2xl:leading-[63px]">
      ...
      <div className="grid gap-3 p-2 lg:p-10 md:hidden lg:hidden">
        {cardss.map((item, index) => (
          <div key={index}>
            <div className="flex flex-col">
              ...
              <div className="-mt-1 text-[16px] text-left p-4 bg-linear-to-r from-[#E1E8F4] to-[#FFFBF0] rounded-b-lg">
