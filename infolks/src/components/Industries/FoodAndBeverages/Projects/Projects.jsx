...
import Plate_dish_labeling from "/industries/food & beverages/Plate-dish-labeling.jpg";
import pizza_labeling from "/industries/food & beverages/pizza-labeling.jpg";
import plate_labeling from "/industries/food & beverages/plate-labeling.jpg";
import food_pan_labeling from "/industries/food & beverages/food-pan-labeling.jpg";

const RecentAnnotations = () => {
  const [currentIndex, setCurrentIndex] = useState(1);
  const [translateValue, setTranslateValue] = useState("81%"); // Default to 80%
  ...
  const data = [
    {
      ...
      headinh1: "Plate & Dish",
      heading2: "Labeling ",
      content: `This project aims to categorize food images by labeling the main dish and its accompanying side dish. By efficiently assigning labels such as "Main Dish" and "Side Dish," we streamline food organization and enhance user experience in culinary applications.`,
      img: Plate_dish_labeling,
    },
    {
      id: "02",
      headinh1: "Pizza",
      heading2: "Labeling",
      content: `Categorizing pizzas, evaluating their quality, and recognizing toppings present on each pizza are our primary objectives. By employing advanced algorithms and machine learning techniques, we streamline the process, ensuring accurate labeling and enhancing the user experience in pizza-related applications.`,
      img: pizza_labeling,
    },
    {
      id: "03",
      headinh1: "Plate",
      heading2: "Labeling",
      content: `Automate plate labeling by assigning unique numerical IDs to food items. Using advanced computer vision and machine learning, we streamline the process for accuracy and efficiency, enhancing organization and analysis in culinary settings.`,
      img: plate_labeling,
    },
    {
      id: "04",
      headinh1: "Food and Pan",
      heading2: "Labeling",
      content: `This project aims to segment food preparation images into predefined classes for efficient food and pan labeling. Utilizing advanced computer vision techniques, we accurately classify various items and utensils, streamlining the process for precise labeling and enhancing organization in culinary settings. This system promises improved efficiency and user experience in kitchen environments.`,
      img: food_pan_labeling,
    },
  ];
