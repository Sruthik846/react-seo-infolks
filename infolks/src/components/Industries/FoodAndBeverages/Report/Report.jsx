...
const Report = ({ reportImage, content, content2, reportContent, reportid }) => {
  ...
  return (
    <div className="flex w-full justify-center items-center flex-col pt-10 lg:pt-16 2xl:pt-28 -mt-16 responsive-section-container">
       ...
       {/* Large screen */}
       <h2 className="hidden lg:block text-center mb-2 lg:mb-5 2xl:mb-10 uppercase heading-h2 mx-auto lg:leading-[50px] 2xl:leading-[63px]">
       DELIVERING THE BEST QUALITY <br/>DATA TO ENHANCE THE FOOD & BEVERAGES SECTOR
      </h2>

      {/* Medium screen */}
      <h2 className="block lg:hidden text-center mb-2 uppercase heading-h2 mx-auto lg:leading-[50px] 2xl:leading-[63px]">
      DELIVERING THE BEST QUALITY DATA TO ENHANCE THE FOOD & BEVERAGES SECTOR
      </h2>
      <div className="text-[16px] md:text-[18px] 3xl:text-[20px] text-center mx-auto container">
        <div className="p-3 md:p-5 lg:p-0 lg:mx-auto lg:w-[90%] 3xl:w-full">
          ...
          {/* end of section */}
            ...
            <div className="grid grid-cols-1 mt-5 h-40 sm:h-28 md:h-28 lg:h-32">
              <div className="relative group">
                <div className="bg-[#FBF7ED] lg:w-full absolute top-0 ml-2 z-0 p-2 md:p-8 rounded-[20px] border border-[#5F82CC]">
                  <p className="paragraph xl:mx-36">{reportContent}</p>
                </div>

                <div className="bg-[#FBF7ED] z-10 ml-2 group-hover:ml-0 group-hover:mt-2 group-hover:mr-2 transition-all duration-300 ease-in-out p-2 md:p-8 rounded-[20px] border border-[#5F82CC]">
                  <p className="paragraph xl:mx-36">{reportContent}</p>
                </div>
              </div>
            </div>
