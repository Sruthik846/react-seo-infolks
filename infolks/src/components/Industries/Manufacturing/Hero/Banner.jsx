...
import manufacturing from "/industries/manufacturing/manufacturing.mp4";
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col mx-auto container justify-center items-center  lg:items-start lg:left-[6%]">
          <h1 className="text-white text-center lg:text-left hero-banner-heading-h1">
            DATA TO REVOLUTIONISE AI IN THE <br />
          ...
          <div className="flex flex-col text-center lg:text-left justify-center items-center lg:justify-start lg:items-start lg:leading-8 text-[#FFFBF0] text-[16px] md:text-[20px] lg:text-[23px] mt-3 w-[90%] lg:w-[70%]">
            <p className="paragraph hidden lg:block">
              Smart technology is reshaping manufacturing, enhancing speed,
              precision, and innovation across production. From automated
              workflows to robotics, this shift relies on quality data labeling.
              Accurate annotations fuel smarter systems, quicker decisions, and
